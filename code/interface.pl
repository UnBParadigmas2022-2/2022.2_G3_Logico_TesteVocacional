...
id_imagem_preg('Voce fala ou tem interesse em falar ingles?','ingles').
id_imagem_preg('Voce gostaria de praticar uma atividade que exige condicionamento fisico?','fisico').
id_imagem_preg('Voce tem interesse em musica ou alguma possibilidade relacionada?','musica').
id_imagem_preg('Voce tem interesse ou alguma aptidao na area de matematica?','matematica').
id_imagem_preg('Voce gosta de conversar com pessoas?','conversa_pessoas').
